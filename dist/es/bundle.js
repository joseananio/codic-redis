...
async function saveTask(task) {
  ...
  await this.db.set(this.keyBase + ":task", JSONfn$1.stringify(_tasks));
  return task;
}
                                              ...
                                              while (1) {
                                                switch (
                                                  ...
                                                  case 2:
                                                    ...
                                                    console.warn(
                                                      taskName +
                                                        " is not a valid task or does not exist"
                                                    );
...
function use(data) {
  this.attrs = _objectSpread$1({}, this.attrs, {
    data: data
  });
  return this;
}
...
function Task(name, config, definition) {
  copyConfig$1(this, _objectSpread$1({}, defaultProps, config));
  this.name = name;
                          ...
                          function _callee$(_context) {
                            while (1) {
                              switch ((_context.prev = _context.next)) {
                                ...
                                case 6:
                                  tasks = _context.sent;
                                  __due_tasks = _toConsumableArray$1(
                                    __due_tasks
                                  ).concat(_toConsumableArray$1(tasks));
...
async function removeTask(name) {
  ...
  await this.db.set(this.keyBase + ":task", JSONfn$1.stringify(tasks));
  return true;
}
...
async function saveActivity(activity) {
  ...
  var exist = current.find(
    x => x._name === activity._name // x.timesheet === activity.timesheet &&
  ...
  if (!exist) {
    ...
    current = current.map(x =>
      x._name === activity._name || x.id === activity.id ? activity : x
    );

  await this.db.set(this.keyBase + ":activity", JSONfn$1.stringify(current));
  activity.driver = this;
  return activity;
}

async function getActivitiesRaw() {
...
async function getNextRunDelay() {
  var dt = null;
  var now = Date.now();
...
async function getActivity(id_name) {
 ...
 */
async function remove$1(id_name) {
  var activities = await this.getActivities();
  var activity = activities.find(
    activity => activity.id === id_name || activity.name === id_name
  );
...
async function getActivitiesRaw$1() {
  return await this.db.del(this.keyBase + ":activity");
}

function Codic$1(driver) {
  this.driver = driver;
}
...
var runtime$1 = createCommonjsModule$1(function(module) {
  /**
   * Copyright (c) 2014-present, Facebook, Inc.
   *
   * This source code is licensed under the MIT license found in the
...
var hadRuntime$1 =
  g$1.regeneratorRuntime &&
  Object.getOwnPropertyNames(g$1).indexOf("regeneratorRuntime") >= 0; // Save the old regeneratorRuntime in case it needs to be restored later.
...
function _ref$3() {
  _ref$3 = _asyncToGenerator$2(
    /*#__PURE__*/
    regenerator$1.mark(function _callee3() {
      var that, r;
      return regenerator$1.wrap(
        function _callee3$(_context3) {
          while (1) {
            switch ((_context3.prev = _context3.next)) {
              case 0:
              ...
              case 3:
                ...
                return r.map(
                  /*#__PURE__*/
                  (function() {
                    var _ref2 = _asyncToGenerator$2(
                      /*#__PURE__*/
                      regenerator$1.mark(function _callee2(activity) {
                        return regenerator$1.wrap(
                          function _callee2$(_context2) {
                            while (1) {
                              switch ((_context2.prev = _context2.next)) {
...
function tryRun$1(_x) {
  return _tryRun$1.apply(this, arguments);
}

function _tryRun$1() {
  _tryRun$1 = _asyncToGenerator$2(
    /*#__PURE__*/
    regenerator$1.mark(function _callee5(codic) {
      return regenerator$1.wrap(
        function _callee5$(_context5) {
          while (1) {
            switch ((_context5.prev = _context5.next)) {
              case 0:
                codic.runThrough(function(err, nextRun) {
                  setTimeout(
                    ...
                    _asyncToGenerator$2(
                      /*#__PURE__*/
                      regenerator$1.mark(function _callee4() {
                        return regenerator$1.wrap(
                          function _callee4$(_context4) {
                            while (1) {
                              switch ((_context4.prev = _context4.next)) {
...
var humanInterval_1 = createCommonjsModule$1(function(module) {
  var humanInterval = (module.exports = function humanInterval(time) {
    if (!time) return time;
    if (typeof time === "number") return time;
    time = swapLanguageToDecimals(time);
    time = time.replace(
      /(second|minute|hour|day|week|month|year)s?(?! ?(s )?and |s?$)/,
      "$1,"
    );
  ...
  function swapLanguageToDecimals(time) {
    ...
    var languageMapRegex = new RegExp(
    ...
    matches.forEach(function(match) {
      var matchStr =
        language[match] > 1
          ? language[match]
          : language[match].toString().slice(1);
...
function every$1(timesheet) {
  this.type = aType$1.REPEAT;
...
function at$1(timesheet) {
  this.type = aType$1.ONCE;
  this.timesheet = timesheet;
  return this.save();
}
/**
...
function disable$2() {
  this.status = status$1.DISABLED;
  return this;
}

function disable$1$1() {
...
function isActive$1() {
  return this.status === status$1.ACTIVE;
}

function createTasks$1(tasks) {
  if (typeof tasks === "string" && tasks.length > 0) tasks = [tasks];
  if (!Array.isArray(tasks)) throw new Error("Tasks requires array or string");
  if (tasks.length == 0) throw new Error("No tasks defined for activity");
  this.tasks = tasks;
...
function save$1() {
  return _save$1.apply(this, arguments);
}

function _save$1() {
  _save$1 = _asyncToGenerator$2(
    /*#__PURE__*/
    regenerator$1.mark(function _callee() {
      return regenerator$1.wrap(
        function _callee$(_context) {
...
function use$1(data) {
  this.attrs = _objectSpread$2({}, this.attrs, {
    data: data
  });
  return this;
}

function copyConfig$2(to, from) {
  if (from.driver) to.driver = from.driver;
  to.id = from.id;
  to._name = from._name;
  Object.keys(from).forEach(function(key) {
...
function Activity$1(tasks, config) {
  this.status = status$1.ACTIVE;
  this.nextRun = null;
  this.lastRun = null;
  this.failedAt = null;
  this.failReason = null;
  this.type = aType$1.TEMP;
  this.timesheet = 1000;
  this._name = "";
  this.driver = null;
  this.attrs = {
  ...
  copyConfig$2(this, config);
  this.createTasks(tasks, this.driver);
}

function getTasks$2() {
  return _ref$1$1.apply(this, arguments);
}

function _ref$1$1() {
  _ref$1$1 = _asyncToGenerator$2(
    /*#__PURE__*/
              ...
              case 0:
                ...
                return this.tasks.map(
                  ...
                  (function() {
                    var _ref2 = _asyncToGenerator$2(
                      /*#__PURE__*/
                      regenerator$1.mark(function _callee(name) {
                        var task;
                        return regenerator$1.wrap(
                          function _callee$(_context) {
                            while (1) {
...
function _updateNextRun() {
  _updateNextRun = _asyncToGenerator$2(
    /*#__PURE__*/
    regenerator$1.mark(function _callee(from) {
      return regenerator$1.wrap(
        function _callee$(_context) {
          while (1) {
            switch ((_context.prev = _context.next)) {
...
var proto = Activity$1.prototype;
proto.at = at$1;
proto.use = use$1;
proto.name = name;
proto.save = save$1;
proto.every = every$1;
proto.isDue = isDue$1;
proto.remove = remove$2;
proto.enable = disable$1$1;
proto.disable = disable$2;
proto.startAt = startAt;
proto.isActive = isActive$1;
proto.getTasks = getTasks$2;
proto.createTasks = createTasks$1;
proto.updateNextRun = updateNextRun;
Activity$1.prototype = proto;

Activity$1.prototype.makeId = function() {
  if (!this.id)
    this.id = Math.random()
      .toString(36)
      .slice(2);
...
function run$1(jobs) {
  var activity = new Activity$1(jobs, {
    driver: this.driver
  });
...
function copyConfig$1$1(to, from) {
  if (from.priority) to.priority = from.priority;
  return to;
}

function Task$1(name, config, definition) {
  copyConfig$1$1(this, _objectSpread$2({}, defaultProps$1, config));
  this.name = name;
  this.definition = definition;
}

function assign$1(_x, _x2) {
  return _assign$1.apply(this, arguments);
}

function _assign$1() {
  _assign$1 = _asyncToGenerator$2(
    /*#__PURE__*/
    regenerator$1.mark(function _callee(name, def) {
      var config,
        task,
        _args = arguments;
      return regenerator$1.wrap(
        function _callee$(_context) {
          while (1) {
            switch ((_context.prev = _context.next)) {
              ...
              case 9:
                task = new Task$1(name, config, def);
                _context.next = 12;
                return this.driver.saveTask(task);
...
function runThrough$1(_x) {
  return _ref$2$1.apply(this, arguments);
}

function _ref$2$1() {
  _ref$2$1 = _asyncToGenerator$2(
    /*#__PURE__*/
    regenerator$1.mark(function _callee2(cb) {
      var now, __due_tasks, __due;
          ...
          while (1) {
            switch ((_context2.prev = _context2.next)) {
              ...
              case 4:
                ...
                return __due.map(
                  ...
                  (function() {
                    var _ref2 = _asyncToGenerator$2(
                      /*#__PURE__*/
                      regenerator$1.mark(function _callee(activity) {
                        var t, tasks;
                        return regenerator$1.wrap(
                          function _callee$(_context) {
                            while (1) {
                              switch ((_context.prev = _context.next)) {
                                ...
                                case 6:
                                  tasks = _context.sent;
                                  __due_tasks = _toConsumableArray$2(
                                    __due_tasks
                                  ).concat(_toConsumableArray$2(tasks));
                                  return _context.abrupt("return", tasks);
              ...
              case 11:
                ...
                _context2.next = 14;
                return r$1(__due_tasks, cb, this.driver);
...
function r$1(_x2, _x3, _x4) {
  return _r$1.apply(this, arguments);
}

function _r$1() {
  _r$1 = _asyncToGenerator$2(
    /*#__PURE__*/
    regenerator$1.mark(function _callee4(tasks, cb, driver) {
      var _runs;
              ...
              case 0:
                ...
                return tasks.map(
                  ...
                  (function() {
                    var _ref3 = _asyncToGenerator$2(
                      /*#__PURE__*/
                      regenerator$1.mark(function _callee3(task) {
                        var activity, fn;
                        return regenerator$1.wrap(
                          function _callee3$(_context3) {
                            while (1) {
...
var proto$1 = Codic$1.prototype;
proto$1.run = run$1;
proto$1.pause = pause$1;
proto$1.start = start$1;
proto$1.assign = assign$1;
proto$1.runThrough = runThrough$1;
Codic$1.prototype = proto$1;
Codic$1.Task = Task$1;
Codic$1.Activity = Activity$1;
...
function recreateActivity(activity) {
  ...
  config.driver = this;
  return new Codic$1.Activity(tasks, config);
}
...
var proto$2 = driver.prototype;
proto$2.saveTask = tasks.saveTask;
proto$2.getTask = tasks.getTask;
proto$2.removeTask = tasks.removeTask;
proto$2.getTasks = tasks.getTasks;
proto$2.getTasksRaw = tasks.getTasksRaw;
proto$2.getActivity = activities.getActivity;
proto$2.saveActivity = activities.saveActivity;
proto$2.getActivities = activities.getActivities;
proto$2.getActiveActivities = activities.getActiveActivities;
proto$2.getActivitiesRaw = activities.getActivitiesRaw;
proto$2.getDueActivities = activities.getDueActivities;
proto$2.getNextRunDelay = activities.getNextRunDelay;
proto$2.dropActivities = activities.clean;
proto$2.dropActivity = activities.remove;
proto$2.getNextRunDelay = activities.getNextRunDelay;
proto$2.recreateActivity = activities.recreateActivity;
driver.prototype = proto$2;
