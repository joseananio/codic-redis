                ...
                return regenerator.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 6:
                        tasks = _context.sent;
                        __due_tasks = _toConsumableArray$1(__due_tasks).concat(_toConsumableArray$1(tasks));
...
async function saveActivity (activity) {
  ...
  var exist = current.find(x => x._name === activity._name // x.timesheet === activity.timesheet &&
  ...
  } else current = current.map(x => x._name === activity._name || x.id === activity.id ? activity : x);
...
async function getActivity (id_name) {
  ...
  var activity = activities.find(activity => activity.id === id_name || activity.name === id_name);
                    ...
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        function () {
                          ...
                          /*#__PURE__*/
                          regenerator$1.mark(function _callee(taskName) {
...
var humanInterval_1 = createCommonjsModule$1(function (module) {
  ...
  function processUnits(time) {
    ...
    if (time.match(/(second|minute|hour|day|week|month|year)s?/) !== null) unit = time.match(/(second|minute|hour|day|week|month|year)s?/)[1];else unit = undefined;
    if (!num) num = 1;
                ...
                return regenerator$1.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 6:
                        tasks = _context.sent;
                        __due_tasks = _toConsumableArray$2(__due_tasks).concat(_toConsumableArray$2(tasks));
                        return _context.abrupt("return", tasks);
